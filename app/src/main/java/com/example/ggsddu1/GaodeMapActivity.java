...
public class GaodeMapActivity extends Activity {
    ...
    private void showLocation() {
        ...
        BitmapDescriptor myLocationIcon = BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher);
        myLocationStyle.myLocationIcon(myLocationIcon);
        aMap.setMyLocationStyle(myLocationStyle);//设置定位蓝点的Style
        aMap.getUiSettings().setMyLocationButtonEnabled(true); //设置默认定位按钮是否显示，非必需设置。
        aMap.getUiSettings().setCompassEnabled(true);
        aMap.getUiSettings().setLogoPosition(AMapOptions.LOGO_MARGIN_RIGHT);
